 ...
 * mientras se escribe y no recién al enviar. Copia de
 * web/src/lib/validacion.ts.
 *
...
const MAS_USADAS = new Set([
  ...
  '12341234', '11223344', 'password', 'password1', 'password123', 'contraseña',
  'contrasena', 'contrasena1', 'qwerty123', 'qwertyui', 'asdfghjk', 'iloveyou',
  'abcd1234', 'abc12345', 'admin123', 'administrador', 'kontago', 'kontago1',
  'kontago123', 'ecuador1', 'ecuador123', 'tienda123', 'minimarket', 'bienvenido',
]);
...
export function fuerzaDeLaContrasena(contrasena: string): {
  ...
  const variedad = [/[a-z]/, /[A-Z]/, /\d/, /[^\w\s]/, /\s/].filter((r) => r.test(contrasena)).length;
