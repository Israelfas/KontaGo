...
export class InitSchema1786864028199 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."usuarios_rol_enum" AS ENUM('admin', 'cajero')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_1f888a563fd811987449e29aa0" ON "usuarios"  ("tenant_id", "email") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_ec7e16dd98e707f583479ded42" ON "ventas"  ("tenant_id", "created_at") `,
    );
    await queryRunner.query(
      `CREATE TABLE "venta_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "venta_id" uuid NOT NULL, "producto_id" uuid NOT NULL, "cantidad" integer NOT NULL, "precio_venta_centavos" integer NOT NULL, "costo_unitario_centavos" integer NOT NULL, CONSTRAINT "PK_6506a1ae8240b069cab6a5c7c96" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "usuarios" ADD CONSTRAINT "FK_7b664ae6b7cda3df230794ff6c1" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "productos" ADD CONSTRAINT "FK_510b416153d3da4180d0a82dfe5" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "ventas" ADD CONSTRAINT "FK_76af321dc97591c0a668730f398" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "venta_items" ADD CONSTRAINT "FK_0c5282608418ad8a536d318219d" FOREIGN KEY ("producto_id") REFERENCES "productos"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ventas" DROP CONSTRAINT "FK_76af321dc97591c0a668730f398"`,
    );
    await queryRunner.query(
      `ALTER TABLE "productos" DROP CONSTRAINT "FK_510b416153d3da4180d0a82dfe5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "usuarios" DROP CONSTRAINT "FK_7b664ae6b7cda3df230794ff6c1"`,
    );
    await queryRunner.query(`DROP TABLE "venta_items"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ec7e16dd98e707f583479ded42"`,
    );
    await queryRunner.query(`DROP TABLE "ventas"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9b88bb0360eca1908d91627bee"`,
    );
    await queryRunner.query(`DROP TABLE "productos"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1f888a563fd811987449e29aa0"`,
    );
